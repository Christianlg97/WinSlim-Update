...
El flujo de detección y actualización mediante WinGet adapta código y patrones de [UniGetUI de Martí Climent](https://github.com/marticliment/UniGetUI), distribuido bajo licencia MIT. El aviso completo se conserva en `THIRD_PARTY_NOTICES.md`.
