...
namespace wumgr
{
    public partial class WuMgr
    {
        ...
        private Control BuildSidebar()
        {
            ...
            Label settingsCaption = CreateLabel("CONFIGURACIÓN", 8F, FontStyle.Bold, Color.FromArgb(116, 132, 164));
        ...
        {
            if (sender != modernSettingsButton)
                ShowUpdatesPage();
        }
        ...
        private void UpdateModernEmptyState()
        {
            ...
            bool empty = updateItems.Count == 0 && !modernLogVisible && !modernSettingsVisible;
            if (!empty)
            {
