...
namespace wumgr
{
    public partial class WuMgr : Form
    {
        ...
        public WuMgr()
        {
            ...
            notifyIcon.ContextMenu.MenuItems.AddRange(new MenuItem[] { menuAbout, new MenuItem("-"), menuExit });
            ...
            InsertMenu(MenuHandle, 6, MF_BYPOSITION, MYMENU_ABOUT, menuAbout.Text);
        ...
        private void menuAbout_Click(object Sender, EventArgs e)
        {
            ...
            About += "Flujo WinGet adaptado de UniGetUI by Martí Climent\r\n";
            About += "\r\n";
            About += "Licencias: \tGNU GPL v3 y componentes MIT\r\n";
            About += string.Format("Versión: \t{0}\r\n", Program.mVersion);
            About += "\r\n";
            About += "Código fuente: \thttps://github.com/DavidXanatos/wumgr\r\n";
            About += "UniGetUI: \thttps://github.com/marticliment/UniGetUI\r\n";
            About += "\r\n";
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            {
                string Info = "";
                ListViewItem selectedItem = packageUpdatesVisible && modernPackageUpdateList != null
                    ? modernPackageUpdateList.SelectedItem
                    : modernUpdateList != null ? modernUpdateList.SelectedItem : null;
                if (selectedItem != null)
                {
